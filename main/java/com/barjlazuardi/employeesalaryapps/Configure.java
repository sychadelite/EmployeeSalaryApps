...
public class Configure {
    // Pegawai
    public static final String URL_ADD_EMP = "http://192.168.0.11/mobile/EmployeeSalaryApps/addEmp.php";
    public static final String URL_GET_ALL_EMP = "http://192.168.0.11/mobile/EmployeeSalaryApps/viewAllEmp.php";
    public static final String URL_GET_EMP = "http://192.168.0.11/mobile/EmployeeSalaryApps/viewEmp.php?id=";
    public static final String URL_UPDATE_EMP = "http://192.168.0.11/mobile/EmployeeSalaryApps/updateEmp.php";
    public static final String URL_DELETE_EMP = "http://192.168.0.11/mobile/EmployeeSalaryApps/deleteEmp.php?id=";

    // Golongan
    public static final String URL_ADD_GOL = "http://192.168.0.11/mobile/EmployeeSalaryApps/addGol.php";
    public static final String URL_GET_ALL_GOL = "http://192.168.0.11/mobile/EmployeeSalaryApps/viewAllGol.php";
    public static final String URL_GET_GOL = "http://192.168.0.11/mobile/EmployeeSalaryApps/viewGol.php?id_golongan=";
    public static final String URL_UPDATE_GOL = "http://192.168.0.11/mobile/EmployeeSalaryApps/updateGol.php";
    public static final String URL_DELETE_GOL = "http://192.168.0.11/mobile/EmployeeSalaryApps/deleteGol.php?id_golongan=";
